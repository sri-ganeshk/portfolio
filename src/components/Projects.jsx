    ...
    <section id="projects" className="section-padding bg-primary">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          {/* Project selector */}
          <motion.div 
            className="md:col-span-4 flex flex-row md:flex-col overflow-x-auto md:overflow-visible" 
          ...
          >
            {projects.map((project, index) => (
              <motion.div
                ...
                className={`min-w-[180px] md:min-w-full border-b md:border-l border-muted ${
          ...
          >
            <motion.div 
              className="bg-secondary bg-opacity-20 p-6 border border-muted border-opacity-10"
              initial={{ y: 20 }}
              animate={{ y: 0 }}
              transition={{ duration: 0.4, delay: 0.1 }}
            >
              <h3 className="text-xl font-semibold mb-3">{projects[activeProject].title}</h3>
              <p className="text-muted mb-6 leading-relaxed">{projects[activeProject].description}</p>
              ...
              <div>
                <h4 className="text-sm font-mono text-light mb-3">TECHNOLOGIES</h4>
              ...
              <div className="mt-8 flex justify-end">
                <a 
                  ...
                  className="font-mono text-xs inline-flex items-center px-6 py-2 border border-light hover:bg-light hover:bg-opacity-5 transition-all duration-300 group"
                >
                  LIVE
